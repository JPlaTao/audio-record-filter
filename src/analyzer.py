...
质量信号（学员说话占比、提问次数等）测量的是**互动数量**，不是**互动质量**。

**学员提问多、说话占比高 ≠ 高质量通话。**
学员可能因为困惑、质疑、或顾问讲错产品而多说话。

遇到以下情况，即使质量信号显示"高质量"，也应严肃降级处理：
- 顾问对产品/服务的描述有**根本性错误**（如把人力资源服务说成IT培训）
- 顾问转换话题**生硬、无过渡**，像在念清单
- 学员的提问指向了**错误的方向**（如一直在问技术问题而非实训就业）
- 学员看似"主动"，实质是因为**内容不对而产生大量问答**，而非真正的深度沟通

> **内容有硬伤 → 直接初级。** 即使覆盖度中等、质量信号高，也不能评为中级或高级。

## ⚠️ 重要：先看反例 —— 避免"看起来像中级，实际是初级"的陷阱

以下案例中，系统曾经误判为中级/高级，但业务方确认为初级。
特别注意它们的特征：
...
示例 2：
  录音：冷松芮
  覆盖度：39%（中），质量分：0.72（⚠️ 高但失真）
  学员状态：提问较多（11次），但问题是关于Python技术培训而非人力资源实训
  问题：**产品描述错误**（把人力资源服务说成IT方向）、转折生硬、顾问追问密度为0
  正确等级：初级
  原因：高质量的互动数量 ≠ 高质量的内容。学员多说话是因为**产品讲错了导致大量纠偏问答**，这种"互动"不能算通话质量好。内容有硬伤 → 稳稳的初级。"""
